...
public class Pa2U2P4DllYfApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("DTO hotel");
		HotelDTO hotelDTO1=this.iHotelService.buscarPorIdDTO(1);
		System.out.println(hotelDTO1);
		
		System.out.println("DTO habitacion");
		HabitacionesDTOIdHotel habitacionesDTOIdHotel=this.iHabitacionService.reporteNumeroHabitacionesPorIDHotel(1);
		System.out.println(habitacionesDTOIdHotel);
		
		System.out.println("fetch lazi");
		Hotel HotelConHabitaciones1=this.iHotelService.buscarHabitacionesPorId(1);
		HotelConHabitaciones1.getHabitaciones().forEach(System.out::println);
